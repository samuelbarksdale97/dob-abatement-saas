...
export function ParsedResults({ violationId }: ParsedResultsProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Duplicate Notice — duplicate handling is done in parse-progress, this is a fallback */}
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-amber-900">Duplicate NOI</h4>
                <p className="mt-1 text-sm text-amber-800">
                  This NOI was identified as a duplicate of an existing record.
                </p>
                <Button
                  size="sm"
                  variant="outline"
                  className="mt-3"
                  onClick={() => router.push(`/dashboard/${duplicateViolationId}`)}
                >
